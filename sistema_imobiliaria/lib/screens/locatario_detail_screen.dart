...
class LocatarioDetailScreen extends StatefulWidget {
  ...
  @override
  State<LocatarioDetailScreen> createState() => _LocatarioDetailScreenState();
}

class _LocatarioDetailScreenState extends State<LocatarioDetailScreen> {
  // Getter para acessar o locatario do widget
  Map<String, dynamic> get locatario => widget.locatario;
    ...
    showDialog(
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          ...
          content: Text(
            'Tem certeza que deseja excluir o locatário "${_formatValue(locatario['nome'])}"?\n\nEsta ação não pode ser desfeita.',
          ),
          actions: [
            TextButton(
            ...
            TextButton(
              onPressed: () async {
                ...
                try {
                  ...
                  // Excluir locatário
                  await DatabaseService.deleteLocatario(locatario['id']);
                  ...
                  if (mounted) {
                    ...
                    ScaffoldMessenger.of(scaffoldContext).showSnackBar(
                      const SnackBar(
                        content: Text('Locatário excluído com sucesso!'),
                  ...
                  if (mounted) {
                    ...
                    ScaffoldMessenger.of(scaffoldContext).showSnackBar(
                      SnackBar(
                        content: Text('Erro ao excluir locatário: ${e.toString()}'),
